...
<head>
  ...
  <meta name="description" content="Data Penjualan untuk kasir." />
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
              <div class="card-body">
                <form action="<?php echo site_url('kasir/data_penjualan'); ?>" method="get">
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-3 d-flex align-items-end">
                      ...
                      <a href="<?php echo site_url('kasir/data_penjualan'); ?>" class="btn btn-secondary ml-2">Reset</a>
                    </div>
                  </div>
                </form>
              </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url('kasir/cetak_nota/' . $item['id_transaksi']); ?>" class="btn btn-sm btn-success">Cetak Nota</a>
                        </td>
                      </tr>
                      <?php endforeach; ?>
                    </tbody>
