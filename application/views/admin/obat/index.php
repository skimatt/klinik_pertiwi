      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <!-- Manajemen Obat Content -->
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Daftar Obat</h5>
                <a href="<?php echo site_url('admin/tambah_obat'); ?>" class="btn btn-primary">
                  <i class="ti ti-plus ti-xs"></i> Tambah Obat
                </a>
              </div>
              <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo site_url('admin/edit_obat/' . $item['id_obat']); ?>" class="btn btn-sm btn-warning">
                            <i class="ti ti-edit ti-xs"></i> Edit
                          </a>
                          <a href="<?php echo site_url('admin/hapus_obat/' . $item['id_obat']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus obat ini?');">
