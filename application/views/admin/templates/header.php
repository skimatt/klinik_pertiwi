    ...
    <div class="navbar-nav align-items-center me-4">
      <div class="nav-item dropdown-style-switcher dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-start dropdown-styles">
          <li><a class="dropdown-item" href="javascript:void(0);" data-theme="light"><i class="ti ti-sun me-3"></i><span>Light</span></a></li>
          <li><a class="dropdown-item" href="javascript:void(0);" data-theme="dark"><i class="ti ti-moon-stars me-3"></i><span>Dark</span></a></li>
          <li><a class="dropdown-item" href="javascript:void(0);" data-theme="system"><i class="ti ti-device-desktop-analytics me-3"></i><span>System</span></a></li>
        </ul>
      </div>
    </div>
...
<li class="nav-item dropdown dropdown-notifications me-3">
  ...
  <ul class="dropdown-menu dropdown-menu-end py-0" style="min-width: 320px; max-height: 400px; overflow-y: auto;">
    ...
    <li class="text-center py-2">
      <a href="<?php echo site_url('admin/laporan_stok_menipis'); ?>" class="text-primary small fw-semibold">
...
<li class="nav-item navbar-dropdown dropdown-user dropdown">
  <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
    <div class="avatar avatar-online">
      <img src="<?php echo base_url('assets/img/avatars/14.png'); ?>" alt="Profile Picture" class="rounded-circle" style="width: 40px; height: 40px;" />
    </div>
  </a>
      ...
      <a class="dropdown-item mt-0" href="javascript:void(0);">
        <div class="d-flex align-items-center">
          <div class="flex-shrink-0 me-2">
            <div class="avatar avatar-online">
              <img src="<?php echo base_url('assets/img/avatars/14.png'); ?>" alt="Profile Picture" class="rounded-circle" style="width: 32px; height: 32px;" />
            </div>
          </div>
          <div class="flex-grow-1">
            <h6 class="mb-0">
              <?php echo htmlspecialchars($this->session->userdata('nama') ?: 'Pengguna'); ?>
            </h6>
          ...
          <li>
            <div class="d-grid px-2 pt-2 pb-1">
              <a class="btn btn-sm btn-danger d-flex" href="<?php echo site_url('auth/logout'); ?>">
