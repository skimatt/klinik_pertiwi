...
<head>
  ...
  <meta name="description" content="Form Edit Kategori untuk pengelolaan stok obat klinik." />
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php echo form_open('admin/edit_kategori/' . $kategori['id_kategori']); ?>
                  <div class="mb-3">
                  ...
                  <div class="mt-4">
                    ...
                    <a href="<?php echo site_url('admin/kategori'); ?>" class="btn btn-secondary">Batal</a>
                  </div>
                <?php echo form_close(); ?>
              </div>
            </div>
