...
<head>
  ...
  <meta name="description" content="Laporan Penjualan untuk pengelolaan stok obat klinik." />
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
              <div class="card-body">
                <form action="<?php echo site_url('admin/laporan_penjualan'); ?>" method="post">
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-3 d-flex align-items-end">
                      ...
                      <a href="<?php echo site_url('admin/laporan_penjualan'); ?>" class="btn btn-secondary ml-2">Reset</a>
                      <?php if ($dari && $sampai): ?>
                        <a href="<?php echo site_url('admin/cetak_penjualan?dari=' . urlencode($dari) . '&sampai=' . urlencode($sampai)); ?>" class="btn btn-success ml-2">Cetak PDF</a>
                      <?php endif; ?>
                    </div>
                  </div>
                </form>
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="card-title mb-0">Laporan Penjualan (<?php echo date('d/m/Y', strtotime($dari)); ?> - <?php echo date('d/m/Y', strtotime($sampai)); ?>)</h5>
              </div>
              <div class="card-body">
